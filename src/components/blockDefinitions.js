export const getBlockDefinitions = () => {
  return [
    ...
    { "type": "process_custom", "message0": "🔁 Quy trình: %1 %2", "args0": [{ "type": "input_dummy" }, { "type": "field_multilinetext", "name": "TEXT", "text": "Bắt đầu bằng..." }], "colour": 45, "previousStatement": "Process", "nextStatement": "Process" },
    ...
    { "type": "limit_scope", "message0": "🛑 Phạm vi: %1 %2", "args0": [{ "type": "input_dummy" }, { "type": "field_multilinetext", "name": "TEXT", "text": "Tuân thủ các giới hạn sau..." }], "colour": 0, "previousStatement": "Limitations", "nextStatement": "Limitations" },
